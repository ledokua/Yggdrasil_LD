...
public class ArmorRegistry {
    ...
    public static final Item PRIEST_ARMOR_HELMET = ItemInit.register(
            new PriestT6ArmorItem(ArmorMaterialRegistry.PRIEST_T6, ArmorItem.Type.HELMET, new Item.Properties().stacksTo(1)),
            "t6_priest_helmet"
    );
    public static final Item PRIEST_ARMOR_CHESTPLATE = ItemInit.register(
            new PriestT6ArmorItem(ArmorMaterialRegistry.PRIEST_T6, ArmorItem.Type.CHESTPLATE, new Item.Properties().stacksTo(1)),
            "t6_priest_chestplate"
    );
    public static final Item PRIEST_ARMOR_LEGGINGS = ItemInit.register(
            new PriestT6ArmorItem(ArmorMaterialRegistry.PRIEST_T6, ArmorItem.Type.LEGGINGS, new Item.Properties().stacksTo(1)),
            "t6_priest_leggings"
    );
    public static final Item PRIEST_ARMOR_BOOTS = ItemInit.register(
            new PriestT6ArmorItem(ArmorMaterialRegistry.PRIEST_T6, ArmorItem.Type.BOOTS, new Item.Properties().stacksTo(1)),
            "t6_priest_boots"
    );

    // FROST_ARMOR_T6
    public static final Item FROST_ARMOR_HELMET = ItemInit.register(
            new FrostT6ArmorItem(ArmorMaterialRegistry.FROST_T6, ArmorItem.Type.HELMET, new Item.Properties().stacksTo(1)),
            "t6_frost_helmet"
    );
    public static final Item FROST_ARMOR_CHESTPLATE = ItemInit.register(
            new FrostT6ArmorItem(ArmorMaterialRegistry.FROST_T6, ArmorItem.Type.CHESTPLATE, new Item.Properties().stacksTo(1)),
            "t6_frost_chestplate"
    );
    public static final Item FROST_ARMOR_LEGGINGS = ItemInit.register(
            new FrostT6ArmorItem(ArmorMaterialRegistry.FROST_T6, ArmorItem.Type.LEGGINGS, new Item.Properties().stacksTo(1)),
            "t6_frost_leggings"
    );
